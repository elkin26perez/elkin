...
const Inicio = () => {
    ...
    return (
        ...
        <div className=" w-full h-screen">
            <header className=" w-full h-10 items-center justify-center flex  border-b border-zinc-600 text-blue-700 font-bold text-2xl"> Solicita todos los permisos que necesites </header>
